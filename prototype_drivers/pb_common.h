...
void pb_clearI2CError(tSensors link, ubyte address);
bool pb_waitForI2CBus(tSensors link);
bool pb_writeI2C(tSensors link, tByteArray &data, int replylen);
bool pb_readI2C(tSensors link, tByteArray &data, int replylen);
