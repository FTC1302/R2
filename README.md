...
1.【严重】机械臂下降时由于负载太轻或者线性滑轨不够顺滑，导致无法顺利降到最低位置，要借助外力才能确保降到最低位置。

2.【严重】右侧称重传感器返回值不对，非常小。

3.【严重】有一个鱼线滑轮歪了，需要调整。

4.【严重】由于调整机械手位置，导致了一系列的结构调整，目前需要解决的是由于抬高了机械臂，导致接圈斜面斜度不够，圈圈掉下来的时候不够流畅。另外，为了提高挂圈的成功率，机械手的挡板调整了方向，但导致接圈时会挡住圈圈下滑，使接圈成功率很差。

5.【改进】机械臂走线已经基本OK，但有些部位固定不稳，还需要进一步优化，底盘线路需要彻底整理，原型板/分线器需要固定。

6.【改进】TETRIX电源线有点短，需要换一根长一点的。

7.【严重】两个机械手的位置在挂圈时对精度要求过高，如果场地的衣架间距不统一就彻底歇菜。

8.【严重】目前的从上倒下的挂圈方式导致只有一次挂圈机会，万一没挂到就会跌落。

9.【改进】机械手抓握方式不够好，握的不够稳，接圈/挂圈都不够顺畅。

10.【改进】按目前的尺寸，在挂圈时，后轮距离地板边缘太近，非常危险，如果能够将轮距再缩短一些会更安全。
11.【改进】线性滑轨需要进一步的润滑和微调，确保运动的顺滑，现在有时个别滑轨的运行不够流畅。
总体性说明：
===========
